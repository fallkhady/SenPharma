    ...
    return (
        <div className="containe">
            ...
            <div className="steppe">
                <Stepper alternativeLabel activeStep={3} connector={<ColorlibConnector />} sx={{
                    width: "300px", marginLeft: "560px", backgroundColor: "#fff", color: "#FCA13A", borderRadius: "10px", padding: "8px 10px", "& .css-1hv8oq8-MuiStepLabel-label.Mui-completed": { color: "#FCA13A" }, "& .Mui-active": {
                        color: "#68727B"
                    },
                    "& .Mui-disabled": {
                        color: "#68727B"
