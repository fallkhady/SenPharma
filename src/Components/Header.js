                        ...
                        <nav className="main-nav " >
                            ...
                            {isResponsiveclose === true ? <>
                                <span className="menubar__button" style={{ display: 'none' }} onClick={toggleClass} > <GrClose />   </span>
                                    ...
                                    <span className="menubar__button" style={{ display: 'none' }} onClick={toggleClass} > <FiMenu />   </span>
                                </>}


                            <ul className={boxClass.join(' ')}>
                                <li className="menu-item" >
                                    <NavLink className="nav-link" exact activeClassName='is-active' onClick={toggleClass} to={`/Accueil`}> Accueil </NavLink>
                                </li>
